...
wget https://rpmfind.net/linux/epel/6/x86_64/Packages/p/php-Smarty-2.6.28-1.el6.noarch.rpm
rpm -Uvh php-Smarty-2.6.28-1.el6.noarch.rpm
...
echo
echo    "if everything passes, create the initial maia Super user"
echo    "login to the  http://$host/maia/login.php?super=register with created initial user"
